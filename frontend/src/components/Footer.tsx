        ...
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
          <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
            <div>
              ...
              <ul className="mt-4 space-y-4">
                ...
                <li><a href="#" className="text-base text-gray-300 hover:text-white">Beta</a></li>
              </ul>
            </div>
            <div>
            ...
            <div>
              ...
              <ul className="mt-4 space-y-4">
                ...
                <li><a href="#" className="text-base text-gray-300 hover:text-white">Copyright</a></li>
              </ul>
            </div>
          </div>
          <div className="mt-12 border-t border-gray-700 pt-8 flex items-center justify-between">
            <div className="flex items-center">
              ...
              <p className="ml-2 text-base text-gray-400">© 2025 DevCollab. All rights reserved.</p>
            </div>
